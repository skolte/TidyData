...
Packages
The R script run_analysis.R requires three packages, 'data.table', 'plyr' and 'dplyr'. If the packages are not installed, the script will attempt to automatically install them.
